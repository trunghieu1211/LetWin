({
    init: function (cmp, event, helper) {
        // var modalCreateAccountDownline = cmp.find("modalCreateAccountDownline");
        // console.log("recordId: ", modalCreateAccountDownline.get("recordId"));
        // let record = component.find("recordId").get("v.value");
        ...
        // var recordId = cmp.get('v.recordChild');
